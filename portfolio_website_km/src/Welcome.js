...
export default function Welcome() {
  return (
    ...
    <div id={styles.welcomeContent}>
        ...
        <p1 id={styles.paragraph2}>I'm a Software Developer that loves to create exciting projects through programming. I'm currently working in Web-Development and pursuing a degree in computer science from the University of Florida</p1>
    </div>
    <div>
